...
const Copilot = () => {
    return (
        <div className="relative min-h-screen font-sans selection:bg-ms-blue/20 selection:text-ms-blue">
            <Helmet>
                <title>Copilot | Microsoft Elevate Blog</title>
                <meta name="description" content="Copilot 관련 블로그 포스트입니다." />
                <meta property="og:title" content="Copilot | Microsoft Elevate Blog" />
                <meta property="og:description" content="Copilot 관련 블로그 포스트입니다." />
            </Helmet>
