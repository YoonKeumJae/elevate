...
> **이런 순간, 익숙하지 않으신가요?** <br>
수행평가 채점까지는 끝냈습니다.
루브릭 점수도 다 입력했고, 필요한 학생에게는 한 줄 코멘트도 남겼습니다.
그런데 채점이 끝나고 나면 이런 고민이 시작됩니다. <br>
> - 이 반에서 가장 많이 막힌 부분은 어디일까? 
> - 누굴 다시 묶어서 보충 지도를 해야 할까? 
> - 다음 차시는 그냥 감으로 다시 설명해야 할까? <br><br>
점수는 남아 있는데, 그 점수를 어떻게 수업으로 이어야 할지는 늘 애매합니다.

그래서 오늘은 이렇게 해보려고 합니다.

- 평소 채점하고 나면 그대로 남겨두는 **수행평가 채점표 그대로**
- 그 데이터를 **Microsoft 365 Copilot**의 **‘분석가(Analyst)’**에게 맡겨
- 다음 수업과 보충 지도를 **근거 기반으로 정해보는 것**

이 과정을 오늘 **분석가 데모**로 함께 보겠습니다.
